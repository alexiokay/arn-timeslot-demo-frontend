...
div.schedule(class="flex flex-col w-full h-auto ")
    ...
    CalendarScheduleSidebar(v-if="selectedTimeslot" :isOpen="isScheduleSidebarOpen" @close="closeSidebar" class="" :date="props.date" :timeslots="timeslots" :timeslot="selectedTimeslot")
